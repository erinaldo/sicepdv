...
namespace SICEpdv
{
    public class Sweda32
    {
        public static int iRetorno = 0;
        ...
        [DllImport("Convecf.dll")]
        public static extern int ECF_AberturaDoDia(string sValor, string sFormaPagamento);
        ...
        [DllImport("Convecf.dll")]
        public static extern int ECF_DataHoraGravacaoUsuarioSWBasicoMFAdicional(StringBuilder dataUsuarioSw,StringBuilder dataSB, StringBuilder mfAdicionalSw);

        [DllImport("Convecf.dll")]
        public static extern int ECF_CGC_IE(string CGC,string IE );

        [DllImport("Convecf.dll")]
        public static extern int ECF_NumeroSubstituicoesProprietario(string numeroSub);

        [DllImport("Convecf.dll")]
        public static extern int ECF_NumeroCaixa(string nCaixa);

        [DllImport("Convecf.dll")]
        public static extern int ECF_SubTotal(string subtotal);

        [DllImport("Convecf.dll")]
        public static extern int ECF_ValorPagoUltimoCupom([MarshalAs(UnmanagedType.VBByRefStr)] ref string valorCupom);

        [DllImport("Convecf.dll")]
        public static extern int ECF_FlagsFiscais(int valor);
        ...
        [DllImport("Convecf.dll")]
        public static extern int ECF_MarcaModeloTipoImpressoraMFD(string marca, string modelo, string Tipo);
