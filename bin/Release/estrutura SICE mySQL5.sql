...
CREATE TABLE `auditoria` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=65290 DEFAULT CHARSET=latin1;
...
CREATE TABLE `clientes` (
  ...
  KEY `Nomes` (`Nome`)
) ENGINE=MyISAM AUTO_INCREMENT=2548 DEFAULT CHARSET=latin1;
...
CREATE TABLE `consultaclientes` (
  ...
  KEY `codigo` (`codigo`),
  KEY `cpfcnpj` (`cpfcnpj`)
) ENGINE=MyISAM AUTO_INCREMENT=36082 DEFAULT CHARSET=latin1;
...
CREATE TABLE `contdocs` (
  ...
  KEY `ip` (`ip`),
  KEY `codigocliente` (`codigocliente`)
) ENGINE=MyISAM AUTO_INCREMENT=84956 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=59847 DEFAULT CHARSET=latin1;
...
CREATE TABLE `crmovclientespagas` (
  ...
  KEY `IndNomecodigo` (`nome`,`codigo`),
  KEY `datacompra` (`datacompra`)
) ENGINE=MyISAM AUTO_INCREMENT=59844 DEFAULT CHARSET=latin1;
...
CREATE TABLE `entradas` (
  ...
  PRIMARY KEY (`inc`),
  KEY `numero` (`numero`)
) ENGINE=MyISAM AUTO_INCREMENT=2915 DEFAULT CHARSET=latin1;
...
CREATE TABLE `vendas` (
  ...
  PRIMARY KEY (`inc`),
  KEY `NewIndex` (`codigo`)
) ENGINE=MyISAM AUTO_INCREMENT=1978 DEFAULT CHARSET=latin1;
