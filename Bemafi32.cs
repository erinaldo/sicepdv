...
namespace SICEpdv
{
    ...
    public class BemaFI32
    {
		...
		*/
        ...
        [DllImport("BemaFi32.dll")]
        public static extern int Bematech_FI_DownloadMFD(string cArquivo, string cTipoDownload, string cCOOInicial, string cCOOFinal, string cUsuario);
        
        [DllImport("BemaFi32.dll")]
        public static extern int Bematech_FI_FormatoDadosMFD(string cArquivoOrigem, string cArquivoDestino, string cTipoFormato,string cTipoDownload, string cCOOInicial, string cCOOFinal, string cUsuario);

        [DllImport("BemaFi32.dll")]
        public static extern int Bematech_FI_InicioFimCOOsMFD(string cCOOInicial, string cCOOFinal);

        [DllImport("BemaFi32.dll")]
        public static extern int Bematech_FI_InicioFimGTsMFD(string cGTInicial, string cGTFinal);

        //[DllImport("BemaFi32.dll")]
        //public static extern int Bematech_FI_DataHoraGravacaoUsuarioSWBasicoMFAdicional(ref string cdataUsuario, ref string cdataSWBasico, ref string cMFAdicional);

        [DllImport("BemaFi32.dll")]
        public static extern int Bematech_FI_DataHoraGravacaoUsuarioSWBasicoMFAdicional([MarshalAs(UnmanagedType.VBByRefStr)] ref string cdataUsuario, [MarshalAs(UnmanagedType.VBByRefStr)] ref string cdataSWBasico, [MarshalAs(UnmanagedType.VBByRefStr)] ref string cMFAdicional);

        [DllImport("BemaFi32.dll")]
        public static extern int Bematech_FI_RelatorioSintegraMFD(int ctipo, string cArqDestino, 
            string cMes, string cAno, string cRazaoSocial, string cEndereco,
            string cNumero,string cComplemento,string cBairro,string cCidade,
        ...
        [DllImport("BemaMFD2.dll")]
        public static extern int BemaGeraRegistrosTipoE(string cArqMFD, string cArqTXT, string cDataIni, string cDataFim, string cRazao, string cEndereco, string par1, string cCMD,
            string par2, string par3, string par4, string par5, string par6, string par7, string par8, string par9, string par10, string par11, string par12, string par13, string par14);

        [DllImport("BemaFi32.dll")]
        public static extern int Bematech_FI_GeraRegistrosCAT52MFDEx(string cArquivoOrigem, string cData, [MarshalAs(UnmanagedType.VBByRefStr)] ref string cArquivoDestino);

        [DllImport("BemaFi32.dll")]
        public static extern int Bematech_FI_GeraRegistrosSpedCompleto(string cArquivoMFD, string cArquivoTXT, string cDataInicial, string cDataFinal, string cPerfil, string cCFOP, string cCODOBSFiscal, string cAliqPIS, string cAliqCOFINS, string cEmpresa, string CodMunicipio);


        [DllImport("sign_bema.DLL", EntryPoint = "md5FromFile", SetLastError = false,
             CharSet = CharSet.Ansi, ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 md5FromFile(string cNomeArquivo, [MarshalAs(UnmanagedType.VBByRefStr)] ref string cMD5);
