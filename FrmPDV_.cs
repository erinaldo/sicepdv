...
namespace SICEpdv
{
    public partial class _pdv : Form
    {
        ...
        public _pdv()
        {
            ...
            try
            {
                ...
                if (Funcoes.VerificarConexaoInternet() && Configuracoes.coefecientePontosIQCard > 0 && !String.IsNullOrEmpty(GlbVariaveis.glb_chaveIQCard) && (DateTime.Now.Subtract(IqCard.horaVerificadoPedido).TotalMinutes > 30))
                {
                    ...
                    lblPedidos.Text = contadorPedido.ToString();
                }
            ...
            if (Funcoes.VerificarConexaoInternet() && !String.IsNullOrEmpty(GlbVariaveis.glb_chaveIQCard) && IqCard.mostrarPainelIQCARD && Configuracoes.coefecientePontosIQCard > 0)
            {
                PainelIQCARD painel = new PainelIQCARD();
                painel.ShowDialog();
            }
        ...
        private void chamaTabela()
        {
            ...
            if (venda.SomaDescontoItens() > 0 && aceitaDesconto == true && venda.SomaItensSemDescontoItens() == 0)
            {
        ...
        {            
                PainelIQCARD pnlIq = new PainelIQCARD();
                pnlIq.ShowDialog();            
        }
        ...
        {
            System.Diagnostics.Process.Start("http://www.iqsistemas.com.br/ajuda");
        }
        ...
        private void btnNextSugestao_Click(object sender, EventArgs e)
        {
            ...
            //int item = rd.Next(sugestao.Count); 
        ...
        {
            txtcodProduto.Text = sugestaoVenda(produto.codigo);
            pnlImpulsionado.Visible = false;
            txtcodProduto.Focus();
        } */
